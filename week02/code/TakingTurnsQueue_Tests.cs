...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: After Bob's second turn, Sue is returned instead of Bob. Turn decrement or queue order is broken.
    ...
    // Defect(s) Found: Sue is returned before Bob as the 6th item. Queue order is not preserved correctly after new insertion.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Tim (infinite) was skipped. Sue was returned instead. Infinite-turn logic for 0 is not handled properly.
    ...
    // Defect(s) Found: Sue was returned instead of Tim in later cycles. Infinite-turn logic for negative values is broken.
